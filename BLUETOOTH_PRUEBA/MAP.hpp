...
//        };
        ...
        /*Actualización de feromonas
            ...
            POSTCONDICIÓN: actualiza las feromonas utilizando la fórmula 4(MIRAR DOCUMENTO FORMULAS.pdf)
        */
        ...
        **************************************************************/
        typedef uint8_t summit; //Vértices del grafo(nodos)
        static const uint8_t INF; //Coste infinito entre dos nodos(no hay camino directo entre ellos)
        ...
        ***************************************************************/
        ...
        /*CONSTRUCTOR sobrecargado para crear el tablero
            ...
            POSTCONDICIÓN: crea un tablero nuevo, asigna el tamaño a las feromonas e inicializa la lista de hormigas.
        */
        explicit Map(summit initial);
                
        /*Método para hacer avanzar una hormiga de un nodo al siguiente utilizando la fórumla de la probabilidad sobre la cuál se elige uno arbitráreamente y condicionado según su probabilidad. Se usa la fórmula 1(MIRAR DOCUMENTO FORMULAS.pdf)
        ...
        */
        ...
        /*Método para saber la distancia de un punto x a otro y, se utiliza la formula 3(MIRAR DOCUMENTO FORMULAS.pdf)
            PRECONDICIÓN: ambos parámetros son adyacentes entre sí, puesto que el grafo es no dirigido, con el que el primer parámetro sea adyacente al segundo nos vale
